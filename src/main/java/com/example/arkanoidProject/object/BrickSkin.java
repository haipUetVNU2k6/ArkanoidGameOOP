...
public enum BrickSkin {
    BRICK1(new String[]{
            "/com/example/arkanoidProject/view/images/brick1.png"
//            "/com/example/arkanoidProject/view/images/brick1_crack1.png",
//            "/com/example/arkanoidProject/view/images/brick1_crack2.png"
    }),

    BRICK2(new String[]{
            "/com/example/arkanoidProject/view/images/brick2.png",
            "/com/example/arkanoidProject/view/images/brick2_crack1.png"
//            "/com/example/arkanoidProject/view/images/brick2_crack2.png"
    }),

    BRICK3(new String[]{
            "/com/example/arkanoidProject/view/images/brick3.png",
            "/com/example/arkanoidProject/view/images/brick3_crack1.png",
            "/com/example/arkanoidProject/view/images/brick3_crack2.png"
    });
